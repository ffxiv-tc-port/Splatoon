...
namespace SplatoonScriptsOfficial.Duties.Endwalker
{
    public class P12S_Pangenesis : SplatoonScript
    {
        ...
        {
            var whiteTower = (IBattleChara)Svc.Objects.First(x => x is IBattleChara o && o.IsCasting == true && o.CastActionId == whiteTowerCast && o.CurrentCastTime < 1);
            var blackTower = (IBattleChara)Svc.Objects.First(x => x is IBattleChara o && o.IsCasting == true && o.CastActionId == blackTowerCast && o.CurrentCastTime < 1);

            PluginLog.Information($"tower casting time: {blackTower.CurrentCastTime}");

            var whitePos = whiteTower.Position.ToVector2();
            var blackPos = blackTower.Position.ToVector2();
