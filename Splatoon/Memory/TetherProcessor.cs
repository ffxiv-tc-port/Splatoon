...
{
    private delegate long ProcessTether(VfxContainer* a1, byte a2, ushort a3, long targetOID, byte a5);
    ...
    private Hook<ProcessTether> ProcessTetherHook = null;

    private delegate long ProcessTetherRemoval(VfxContainer* a1, byte a2, ushort a3, byte a4, byte a5);
    ...
    private Hook<ProcessTetherRemoval> ProcessTetherRemovalHook = null;
